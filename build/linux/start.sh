...
docker run --ipc host --gpus all --privileged -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/liang/python/deepfake/DeepFaceLab/workspace:/data/  --rm -it deepfacelive
#docker run --ipc host --gpus all --privileged -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/liang/python/deepfake/DeepFaceLab/workspace:/data/  --rm -it deepfacelive bash
